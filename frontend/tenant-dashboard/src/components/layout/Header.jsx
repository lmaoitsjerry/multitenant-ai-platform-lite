          ...
          notifications.map((notification) => {
            ...
            return (
              <div
                ...
                className={`flex gap-3 p-4 hover:bg-gray-50 cursor-pointer border-b border-gray-100 ${
              ...
              >
                <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                  ...
                  <IconComponent className={`w-5 h-5 ${
                    !notification.read ? 'text-theme-primary' : 'text-gray-500'
                  }`} />
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400 mt-1">{notification.time_ago || notification.time}</p>
                </div>
                {!notification.read && (
