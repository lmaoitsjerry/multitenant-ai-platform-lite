...
export default function Login() {
  ...
  const [loginError, setLoginError] = useState(null);  // Local error state for immediate display
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    setLoginError(null);  // Clear local error
    clearError();
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-theme-surface rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Error Message */}
            {(error || loginError) && (
              <div className="bg-red-100 border-2 border-red-400 text-red-800 px-4 py-3 rounded-lg text-sm font-medium flex items-start gap-2">
