...
Output: All 19 bare exception handlers replaced with proper logging, unused logger.py deleted.
</objective>
...
<task type="auto">
  ...
  <action>
Replace all bare `except:` clauses with proper exception handling. There are 9 instances:
...
```
  ...
  <done>All 9 bare exception handlers in email_webhook.py replaced with proper exception handling and logging</done>
</task>
