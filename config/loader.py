...
class ClientConfig:
    """Load and validate client configuration from YAML"""
    ...
    def gcp_region(self) -> str:
        """GCP region"""
        return self.config['infrastructure']['gcp']['region']
    ...
    def smtp_host(self) -> str:
        """SMTP server host"""
        return self.config['email']['smtp']['host']
    
    @property
    def smtp_port(self) -> int:
        """SMTP server port"""
        return self.config['email']['smtp']['port']
    
    @property
    def smtp_username(self) -> str:
        """SMTP username"""
        return self.config['email']['smtp']['username']
    
    @property
    def smtp_password(self) -> Optional[str]:
        """SMTP password"""
        return self.config['email']['smtp'].get('password')
    
    @property
    def imap_host(self) -> str:
        """IMAP server host"""
        return self.config['email']['imap']['host']
    
    @property
    def imap_port(self) -> int:
        """IMAP server port"""
        return self.config['email']['imap']['port']
...
def list_clients() -> List[str]:
    """
    List all available client IDs by scanning the clients directory.
